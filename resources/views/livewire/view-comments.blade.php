<div wire:poll.5s>
    <ul role="list" class="space-y-6">
        ...
        <li class="relative flex gap-x-4">
            ...
            <div class="flex-auto rounded-md p-3 ring-1 ring-inset ring-gray-200">
                <div class="flex justify-between gap-x-4">
                <div class="py-0.5 text-sm leading-5 text-gray-500"><span class="font-medium text-gray-900">test</span> <span class="text-xs">commented</span> </div>
                <time datetime="2023-01-23T15:56" class="flex-none py-0.5 text-2xs leading-5 text-gray-500">1</time>
                </div>
                <p class="text-sm leading-6 text-gray-500 break-words pr-5">ttteteesst</p>
            </div>
            </li>
            <li class="relative flex gap-x-4">
                <div class="absolute left-0 top-0 flex w-6 justify-center -bottom-6">
