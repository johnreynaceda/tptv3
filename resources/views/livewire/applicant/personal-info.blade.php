        ...
        <x-card shadow="shadow-none" title="Personal Information">
                    ...
                    <div class="mt-4">
                        ...
                        @if ($photo)
                            <div class="mt-2 space-y-2">
                                ...
                                <div>
                                    <p class="text-xs font-semibold text-green-600 mb-1">📸 New Photo (Not Saved Yet):
                                    </p>
                        ...
                        {{-- Trigger Modal --}}
                        <x-button positive wire:click="openCameraModal" class="mt-3">
            ...
            <x-slot name="footer">
                <div class="flex justify-end">
                    @if (auth()->user()->step == '2')
                        @if ($this->personal_information)
                            <x-button positive wire:click="update">
                                Update
                            </x-button>
                        @else
