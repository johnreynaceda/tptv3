<div>
  <div class="border border-gray-300 rounded-md">
    <x-card shadow="shadow-none" title="Payment">
      <div class="mb-4">
      ...
      <form>
        ...
        <div class="space-y-3">
          <div class="space-y-3">
            <x-input label="Receipt Number" wire:model.defer="reference_number"
              hint="Receipt number from your payment receipt" />
            <x-input type="file" wire:model="proofs" multiple accept="image/*" label="Proof of payment"
              hint="Please upload the actual photo of receipt" />
          </div>
          <div id="laoding">
            <div wire:loading.flex wire:target="proofs">
      ...
      <x-slot name="footer">
        <div class="flex justify-end">
          <x-button wire:click="submit" spinner="submit" positive>
            Submit
          </x-button>
        </div>
      </x-slot>
