        ...
        <div class="grid grid-cols-4">
          ...
          <div class="col-span-3">
            <div class="overflow-hidden ">
              ...
              <div class=" border-t-2 border-black mt-3 mx-6">
                <h1 class="font-bold">Appointment Details</h1>
                <div class="mt-2">
                  <h1 class="text-gray-600 text-sm">Date of Exam:
                    {{ \Carbon\Carbon::parse(auth()->user()->application->student_slot->slot->date_of_exam)->format('F d, Y') }}
                  </h1>
                  <h1 class="text-gray-600 text-sm">Time:
                  ...
                  <h1 class="text-gray-600 text-sm">Seat Number:
