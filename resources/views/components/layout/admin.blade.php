                ...
                <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                    ...
                    <nav class="flex-1 px-2 mt-10 space-y-1 bg-white">
                        ...
                        <a href="{{ route('admin.examinations') }}"
                            ...
                            <svg class="{{ Request::routeIs(['admin.examinations', 'admin.permit']) ? 'text-white' : 'text-gray-400 group-hover:text-gray-500' }}flex-shrink-0 w-6 h-6 mr-3 "
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="2" stroke="currentColor" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
                        ...
                        <a href="{{ route('admin.campuses') }}"
                            ...
                            <svg class="{{ Request::routeIs(['admin.campuses']) ? 'text-white' : 'text-gray-400 group-hover:text-gray-500' }}flex-shrink-0 w-6 h-6 mr-3 "
              ...
              Reports
                        ...
                        <div x-data="{ open: false }" @click.away="open = false" class="relative ">
                            <button @click="open = !open"
                                class="w-full group inline-flex items-center px-2 py-2 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 focus:outline-none">
                                <!-- Heroicon name: outline/chart-bar -->
                                ...
                                Reports
                                <svg x-bind:class="{ 'text-gray-400 rotate-180': open, 'text-gray-300': !open }"
                                    class="flex-shrink-0 ml-1.5 mt-1 h-5 w-5 transition-transform duration-200 transform group-hover:text-gray-500"
                            ...
                            <div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
                                ...
                                class="origin-top-left absolute left-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                                <div class="py-1" role="menu" aria-orientation="vertical"
                                    aria-labelledby="menu-button" tabindex="-1">
                                    <a href="{{ route('admin.result-report') }}"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
                                        role="menuitem" tabindex="-1">Preferred Courses</a>
                                    <a href="{{ route('admin.ranking-report') }}"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
                                        role="menuitem" tabindex="-1">Ranking Report</a>
                                    <a href="{{ route('admin.qualified-students-report') }}"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
                                        role="menuitem" tabindex="-1">Qualified Students</a>
                                    <a href="{{ route('admin.students-score') }}"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
                                        role="menuitem" tabindex="-1">Student Scores</a>
                                    <a href="{{ route('admin.reports') }}"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
                                        role="menuitem" tabindex="-1">Room Assignment</a>
                                    <a href="{{ route('admin.student-list-report') }}"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
                                        role="menuitem" tabindex="-1">Student List</a>
                                    <a href="{{ route('admin.registration-date-report') }}"
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
                                        role="menuitem" tabindex="-1">Registration Date</a>
                                </div>
                            </div>
                        ...
                        <div class="mt-10">
                            ...
                            <a href="{{ route('admin.examination-with-results') }}"
                                ...
                                <svg class="{{ Request::routeIs(['admin.examination-with-results']) ? 'text-white' : 'text-gray-400 group-hover:text-gray-500' }} flex-shrink-0 w-6 h-6 mr-3"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="2" stroke="currentColor" aria-hidden="true">
